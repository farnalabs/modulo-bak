...
Revision ID: 0154_add_hot_query_indexes
Revises: 0153_promote_uuid_fk_columns
...
revision: str = "0154_add_hot_query_indexes"
down_revision: str | None = "0153_promote_uuid_fk_columns"
