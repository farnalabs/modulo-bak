...
Revision ID: 0154_add_check_constraints
Revises: 0153_add_missing_foreign_keys
...
revision: str = "0154_add_check_constraints"
down_revision: str | None = "0153_add_missing_foreign_keys"
