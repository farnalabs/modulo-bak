...
Revision ID: 0163_add_check_constraints
Revises: 0162_add_missing_foreign_keys
...
revision: str = "0163_add_check_constraints"
down_revision: str | None = "0162_add_missing_foreign_keys"
