...
Revision ID: 0162_add_hot_query_indexes
Revises: 0161_promote_uuid_fk_columns
...
revision: str = "0162_add_hot_query_indexes"
down_revision: str | None = "0161_promote_uuid_fk_columns"
