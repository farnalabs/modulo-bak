...
Revision ID: 0161_add_hot_query_indexes
Revises: 0160_promote_uuid_fk_columns
...
revision: str = "0161_add_hot_query_indexes"
down_revision: str | None = "0160_promote_uuid_fk_columns"
