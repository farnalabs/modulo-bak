...
_FAILURE_BUCKET_STATUSES: frozenset[str] = frozenset(
    {"failed", "cancelled", "eval_failed", "expired", "stalled", "compensation_failed"}
)
_FAILURE_REASON_STATUSES: frozenset[str] = frozenset({"failed", "eval_failed", "stalled", "compensation_failed"})
...
_UPDATE_STATUS_FENCED_SQL = text(
    ...
    "'budget_exceeded', 'cost_ceiling_exceeded', 'compensation_failed') THEN now() "
