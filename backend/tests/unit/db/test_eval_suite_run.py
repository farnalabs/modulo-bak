...
def test_single_migration_head() -> None:
    ...
    # 0169_connector_instance_degraded (FAR-495) chains off 0168 and is the head of that branch.
    ...
    # 0170_add_residual_foreign_keys (DB-improvement residual FK sweep) chains off 0169_connector_instance_degraded.
