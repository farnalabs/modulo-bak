...
class TestMigrationBackfillGrace:
    def test_migration_backfills_epoch_and_branches_off_current_head(self) -> None:
        ...
        # FAR-419 (0158_pipeline_retry_compensation) is the current single head,
        # chained off main's 0157_add_numeric_check_constraints.
        assert heads == ["0158_pipeline_retry_compensation"], f"expected a single head, got {heads}"
